export const metadata = {
  ...
  description: "Klerq's demonstration quickstart shows how the fictional document-processing API accepts a document and returns extracted fields with confidence scores.",
  title: "Klerq Docs",
};
