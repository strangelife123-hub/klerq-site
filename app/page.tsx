...
#     "currency": "EUR", "due_date": "2024-06-30" }`}</code>
          ...
          <img src="/product-shot.svg" alt="Klerq document extraction output showing vendor, total, currency, due date and confidence fields in structured JSON" width={960} height={420} style={{ maxWidth: "100%", marginTop: 32, borderRadius: 12, border: "1px solid var(--border)" }} />
        </div>
      </section>
